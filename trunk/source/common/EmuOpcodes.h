...
enum class EmuOpcode_t : uint8_t {
	...
	EMUOP_REQUEST_ZONE_TRANSFER = 11,
	EMUOP_ZONE_TRANSFER_REPLY = 12,
	EMUOP_NOTIFY_CHARACTER_LINKDEAD = 13,
	EMUOP_CHARACTER_LINKDEAD_TIMEOUT = 14,
	EMUOP_ITEM_ID_REQUEST = 15,
	EMUOP_ITEM_ID_REPLY = 16
};
