...
// Server -> Client
RegisterLoginStruct("OP_AllCharactersDescReplyMsg", OP_AllCharactersDescReplyMsg_Packet, 1, 284, 1096, 1193, 60114, 67650);
...
RegisterLoginStruct("OP_LoginRequestMsg", OP_LoginRequestMsg_Packet, 283, 284, 1169, 57000, 57015);
