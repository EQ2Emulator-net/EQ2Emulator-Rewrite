...
RegisterZoneSubstruct(Substruct_GroupMember, 1188, 57048, 61532);
RegisterZoneSubstruct(Substruct_GroupMemberAppearance, 60114);
RegisterZoneSubstruct(Substruct_GroupMemberMapLocation, 60114);
RegisterZoneSubstruct(Substruct_GroupSheet, 1, 1188, 67650);
RegisterZoneSubstruct(Substruct_RaidSheet, 1);
RegisterZoneSubstruct(UpdateCharacterSheetMsgData, 1, 60114, 67650, 67742);
