...
RegisterZoneSubstruct(Substruct_GroupMember, 1199, 57048, 61532, 69195);
...
RegisterZoneSubstruct(Substruct_SpellProps, 1199, 60114, 67650, 67804);
RegisterZoneSubstruct(Substruct_TsSpellProps, 1199, 60114);
RegisterZoneSubstruct(UpdateCharacterSheetMsgData, 1, 1208, 60114, 67650, 67730, 67804, 69195);
