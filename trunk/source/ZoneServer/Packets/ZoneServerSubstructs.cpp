...
RegisterZoneSubstruct(Substruct_SpawnPosition, 283, 284, 918, 936, 1096, 1119, 1142);
RegisterZoneSubstruct(Substruct_TargetSpellInfo, 1, 919, 936, 1188, 60038);
RegisterZoneSubstruct(Substruct_SpawnInfo, 283, 284, 839, 864, 936, 945, 954, 996, 1096, 1119, 1161, 1188, 1198, 57080, 60038, 67633, 67804);
RegisterZoneSubstruct(Substruct_SpawnVisualization, 1, 936, 955, 1096, 1119, 1142, 1188, 60038);
...
RegisterZoneSubstruct(Substruct_SpellEffects, 1, 839, 1193);
...
RegisterZoneSubstruct(Substruct_SpellProps, 839, 844, 1199, 60114, 67650, 67804);
RegisterZoneSubstruct(Substruct_TsSpellProps, 1199, 60114);
RegisterZoneSubstruct(UpdateCharacterSheetMsgData, 1, 843, 865, 1208, 60114, 67650, 67730, 67804, 69195, 69283, 70704);
